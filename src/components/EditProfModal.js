    ...
    >
      ...
      <Modal.Body>
        ...
        <Row>
            ...
            disabled defaultValue={this.props.professorid} placeholder="ProfessorID"/>
            </Form.Group>

             <Form.Group controlId="ProfessorName">
            <Form.Label>Name:</Form.Label>
            <Form.Control type="text" name="ProfessorName" required
            defaultValue={this.props.professorname}
             placeholder="ProfessorName"/>
            </Form.Group>

            <Form.Group controlId="ProfessorSurname">
            <Form.Label>Surname:</Form.Label>
            <Form.Control type="text" name="ProfessorSurname" required
            defaultValue={this.props.professorsurname}
             placeholder="ProfessorSurname"/>
            </Form.Group>

            <Form.Group controlId="ProfessorSubject">
            <Form.Label>Subject:</Form.Label>
            <Form.Control type="text" name="ProfessorSubject" required
            defaultValue={this.props.professorsubject}
             placeholder="ProfessorSubject"/>
            </Form.Group>
            ...
            <Form.Group>
            <Button variant="danger" type="submit">Update Professor</Button>
            </Form.Group>
            </Form>
            </Col>
        </Row>
